...
class Text
{
     ...
     *
     * @return string Valid color or empty string if invalid
     */
     ...
     * @return string
     */
    public static function detail($text): string
    {
        if ($text === null || $text === '') {
            return '';
        }
     ...
     */
    public static function htmlText($text, bool $double_encode = true, array $allowedTags = ['em', 'b', 'strong', 'i']): string
    {
        if ($text === null || $text === '') {
            return '';
        }
        ...
        $escaped = self::htmlspecialchars($allowed, $double_encode);

        // Restore allowed tags
        return str_replace(array_keys($placeholders), array_values($placeholders), $escaped);
    }
