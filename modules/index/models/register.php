...
class Model extends \Kotchasan\Model
{
    ...
    public static function activateAccount($userId, $code)
    {
        ...
        // Log activation
        \Index\Log\Model::add($userId, 'Auth', 'ACCOUNT_ACTIVATED', $userId);
    ...
    public static function activateUser($code)
    {
        ...
        // Log activation
        try {
            \Index\Log\Model::add($user->id, 'Auth', 'ACCOUNT_ACTIVATED_VIA_EMAIL', $user->id);
        } catch (\Exception $e) {
            // Silently fail
        }
    ...
    private static function logRegistration($userId)
    {
        try {
            ...
            \Index\Log\Model::add($userId, 'Auth', 'REGISTRATION IP: '.$clientIp, $userId);
        } catch (\Exception $e) {
            // Silently fail
        }
    }
